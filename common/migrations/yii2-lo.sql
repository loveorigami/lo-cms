...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 21 2015 г., 17:21
...
('/core/sypex-dumper/index', 2, NULL, NULL, NULL, 1445011282, 1445011282),
...
CREATE TABLE IF NOT EXISTS `mx_i18n_source_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1275 ;
...
(32, 'Sypex Dumper', 13, '/core/sypex-dumper/index', 8, NULL);
