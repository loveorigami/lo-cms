...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 20 2015 г., 14:18
...
--
CREATE DATABASE IF NOT EXISTS `yii2-user` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `yii2-user`;
...
CREATE TABLE IF NOT EXISTS `mx_i18n_source_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1130 ;
